...
|[Introduction to R for metagenomics](https://nselem.github.io/introduction-to-R-for-metagenomics/) | Use command-line tools to perform quality control, taxonomic assignment, and diversity exploration. |
